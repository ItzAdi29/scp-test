...
class servicemanRegistrationForm(UserCreationForm):

    def __init__(self, *args, **kwargs):
        super(servicemanRegistrationForm, self).__init__(*args, **kwargs)
        self.fields['first_name'].label = "First Name"
        self.fields['last_name'].label = "Last Name"
        self.fields['password1'].label = "Password"
        self.fields['password2'].label = "Confirm Password"
...
class servicemanProfileUpdateForm(forms.ModelForm):

    def __init__(self, *args, **kwargs):
        super(servicemanProfileUpdateForm, self).__init__(*args, **kwargs)
        self.fields['first_name'].widget.attrs.update(
            {
                'placeholder': 'Enter First Name',
            }
